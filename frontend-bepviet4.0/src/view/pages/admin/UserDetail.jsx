        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white rounded-[32px] p-8 shadow-sm border border-slate-100 text-center">
            <div className="relative inline-block">
              <img src={user_info.avatar? `http://127.0.0.1:8000/${user_info.avatar}`
                    : 'http://127.0.0.1:8000/images/avatar.png'} className="w-32 h-32 rounded-full border-4 border-emerald-50 mx-auto object-cover" alt="" />
